...
const texts = {
  es: { thingsToDo: 'Cosas que hacer en', topCities: 'Los mejores lugares para visitar en', allExperiences: 'Todas las experiencias en', cities: 'ciudades', experiences: 'experiencias', from: 'Desde', seeAll: 'Ver todas', citiesIn: 'Ciudades en', countries: 'Países' },
  en: { thingsToDo: 'Things to do in', topCities: 'Top places to visit in', allExperiences: 'All experiences in', cities: 'cities', experiences: 'experiences', from: 'From', seeAll: 'See all', citiesIn: 'Cities in', countries: 'Countries' },
  fr: { thingsToDo: 'Choses à faire à', topCities: 'Les meilleurs endroits à visiter en', allExperiences: 'Toutes les expériences en', cities: 'villes', experiences: 'expériences', from: 'À partir de', seeAll: 'Voir tout', citiesIn: 'Villes en', countries: 'Pays' },
  it: { thingsToDo: 'Cose da fare in', topCities: 'I migliori posti da visitare in', allExperiences: 'Tutte le esperienze in', cities: 'città', experiences: 'esperienze', from: 'Da', seeAll: 'Vedi tutto', citiesIn: 'Città in', countries: 'Paesi' },
  de: { thingsToDo: 'Aktivitäten in', topCities: 'Die besten Orte in', allExperiences: 'Alle Erlebnisse in', cities: 'Städte', experiences: 'Erlebnisse', from: 'Ab', seeAll: 'Alle anzeigen', citiesIn: 'Städte in', countries: 'Länder' },
};
...
export default async function CountryPage({ params }: PageProps) {
  ...
  const sortedCities = citiesWithCount.sort((a, b) => b.experienceCount - a.experienceCount);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {experiences.length > 0 && (
          <section className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">{txt.allExperiences} {country.name}</h2>
        ...
        {sortedCities.length === 0 && experiences.length === 0 && (
