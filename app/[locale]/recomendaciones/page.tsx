...
export default async function RecomendacionesPage({ params }: PageProps) {
  ...
  const titles: Record<string, string> = {
    ...
    en: '💎 Ridatours Recommendations',
    fr: '💎 Recommandations Ridatours',
    it: '💎 Raccomandazioni Ridatours',
    de: '💎 Ridatours Empfehlungen'
  };

  const subtitles: Record<string, string> = {
    es: 'Experiencias seleccionadas por nuestro equipo',
    en: 'Experiences selected by our team',
    fr: 'Expériences sélectionnées par notre équipe',
    it: 'Esperienze selezionate dal nostro team',
    de: 'Von unserem Team ausgewählte Erlebnisse'
  };
