...
export default async function MundoPage({ params }: PageProps) {
  ...
  const titles: Record<string, string> = {
    es: '🌍 Las mejores del mundo',
    en: '🌍 Best in the world',
    fr: '🌍 Les meilleures du monde',
    it: '🌍 Le migliori del mondo',
    de: '🌍 Die besten der Welt'
  };

  const subtitles: Record<string, string> = {
    es: 'Experiencias con las mejores valoraciones',
    en: 'Top rated experiences',
    fr: 'Expériences les mieux notées',
    it: 'Esperienze con le migliori valutazioni',
    de: 'Bestbewertete Erlebnisse'
  };
