  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumb items={[{ label: 'Inicio', href: '/es' }, { label: 'Recomendaciones' }]} />
        <div className="mt-6 mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">💜 Nuestras recomendaciones</h1>
          <p className="text-xl text-gray-600">Experiencias seleccionadas especialmente para ti</p>
        </div>
